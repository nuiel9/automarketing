...
|---|---|---|---|
| ~~**Feed-only placements while the creative is 1:1**~~ — **result in, and it was not the lever** | Day-1: ~⅔ of delivery went to Reels/in-stream, Instagram Feed got 1 result. | **Tested 2026-08-11.** CTR rose 0.85% → **~2.12% incremental while delivery was still Reels-heavy**, so the gain came from the CTA/headline/landing-page fixes, not from placements. ⚠️ And the supporting claim was partly wrong: **`facebook_reels_overlay` (4,069 of ~7,071 impressions) is a banner overlaid on a Reel, not a full-screen 9:16 takeover** — a 1:1 image is fine there. Only full-screen Reels and Stories were a real mismatch. | "Exclude Reels" is too broad. Restricting to 2 placements raises CPM for a benefit this test did not demonstrate |
